...
export default function ChatBotsPage() {
  ...
  useEffect(()=>{
    const prompt = "Agora você um especialista em logistica e estara preparado para responder a todas as perguntas relacionadas a logistica na amazonia. Seu foco será em aspectos como padrões climáticos, fenômenos meteorológicos, impactos ambientais e a relação entre a floresta amazônica e a logistica nas cidades dentro da amazonia. Responda a todas as perguntas garatindo que estejam dentro desse contexto"
